...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = (locale === "es" ? ("Ayuda y asistencia para comprar") : locale === "de" ? ("Hilfe und Kaufberatung") : locale === "it" ? ("Aiuto e assistenza all'acquisto") : locale === "en" ? "Help and buying support" : locale === "fr" ? "Aide et accompagnement à l’achat" : "Ajuda e apoio à compra");
  const description = (locale === "es" ? ("Descubre c\u00F3mo comprar, personalizar y hacer el seguimiento de tus productos promocionales con 360 Merchandising.") : locale === "de" ? ("Erfahren Sie, wie Sie Werbeartikel bei 360 Merchandising kaufen, personalisieren und nachverfolgen.") : locale === "it" ? ("Scopri come acquistare, personalizzare e seguire i tuoi prodotti promozionali con 360 Merchandising.") : locale === "en" ? "Learn how to buy, customise and track promotional products with 360 Merchandising." : locale === "fr" ? "Découvrez comment acheter, personnaliser et suivre vos objets publicitaires avec 360 Merchandising." : "Saiba como comprar, personalizar e acompanhar merchandising e brindes promocionais na 360 Merchandising.");
...
export default async function HelpPage() {
  ...
  const copy = (locale === "es" ? ({
    back: "Volver al inicio", eyebrow: "Ayuda", title: "\u00BFC\u00F3mo podemos ayudarte?", intro: "Encuentra informaci\u00F3n sobre compra directa, personalizaci\u00F3n, solicitudes a medida, stock, plazos, pago y seguimiento de pedidos.", placeholder: "Buscar productos o temas de ayuda", supportTitle: "\u00BFNecesitas asistencia personalizada?", supportText: "Para campa\u00F1as complejas, grandes cantidades o personalizaciones espec\u00EDficas, env\u00EDanos una solicitud a medida.", supportCta: "Enviar una solicitud a medida",
    topics: [["C\u00F3mo comprar", "Elige un producto, configura la cantidad y la personalizaci\u00F3n, a\u00F1\u00E1delo al carrito y completa la compra."], ["Personalizaci\u00F3n", "Selecciona una t\u00E9cnica, indica las instrucciones de impresi\u00F3n y carga tu logotipo durante la personalizaci\u00F3n."], ["Stock y plazos", "El stock, los precios y los detalles de los productos se sincronizan directamente con el proveedor."], ["Env\u00EDo", "Las opciones y los costes de entrega disponibles se muestran al finalizar la compra, antes de confirmar el pedido."]],
}) : locale === "de" ? ({
    back: "Zur Startseite", eyebrow: "Hilfe", title: "Wie k\u00F6nnen wir Ihnen helfen?", intro: "Hier finden Sie Informationen zu Direktbestellungen, Personalisierung, individuellen Anfragen, Bestand, Lieferzeiten, Bezahlung und Bestellverfolgung.", placeholder: "Produkte oder Hilfethemen suchen", supportTitle: "Ben\u00F6tigen Sie individuelle Unterst\u00FCtzung?", supportText: "Senden Sie uns bei komplexen Kampagnen, gro\u00DFen Mengen oder besonderen Personalisierungsw\u00FCnschen eine individuelle Anfrage.", supportCta: "Individuelle Anfrage senden",
    topics: [["So kaufen Sie ein", "W\u00E4hlen Sie ein Produkt, legen Sie Menge und Personalisierung fest, f\u00FCgen Sie es dem Warenkorb hinzu und schlie\u00DFen Sie die Bestellung ab."], ["Personalisierung", "W\u00E4hlen Sie eine Technik, geben Sie Druckanweisungen an und laden Sie w\u00E4hrend der Personalisierung Ihr Logo hoch."], ["Bestand und Lieferzeiten", "Best\u00E4nde, Preise und Produktdetails werden direkt mit dem Lieferanten synchronisiert."], ["Versand", "Verf\u00FCgbare Lieferoptionen und Kosten werden vor der Bestellbest\u00E4tigung an der Kasse angezeigt."]],
}) : locale === "it" ? ({
    back: "Torna alla pagina iniziale", eyebrow: "Aiuto", title: "Come possiamo aiutarti?", intro: "Trova informazioni su acquisti diretti, personalizzazione, richieste su misura, disponibilit\u00E0, tempi, pagamento e monitoraggio degli ordini.", placeholder: "Cerca prodotti o argomenti di aiuto", supportTitle: "Hai bisogno di assistenza personalizzata?", supportText: "Per campagne complesse, grandi quantit\u00E0 o personalizzazioni specifiche, inviaci una richiesta su misura.", supportCta: "Invia una richiesta su misura",
    topics: [["Come acquistare", "Scegli un prodotto, imposta quantit\u00E0 e personalizzazione, aggiungilo al carrello e completa l'acquisto."], ["Personalizzazione", "Seleziona una tecnica, indica le istruzioni di stampa e carica il tuo logo durante la personalizzazione."], ["Disponibilit\u00E0 e tempi", "Disponibilit\u00E0, prezzi e dettagli dei prodotti vengono sincronizzati direttamente con il fornitore."], ["Spedizione", "Le opzioni e i costi di consegna disponibili vengono mostrati al momento del pagamento, prima di confermare l'ordine."]],
}) : locale === "en" ? {

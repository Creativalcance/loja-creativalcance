...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = (locale === "es" ? ("Encuentra merchandising adecuado para tus necesidades, cantidad y presupuesto.") : locale === "de" ? ("Finden Sie Merchandising passend zu Bedarf, Menge und Budget.") : locale === "it" ? ("Trova merchandising adatto alle tue esigenze, alla quantit\u00E0 e al budget.") : locale === "en" ? "Find merchandise suited to your requirements, quantity and budget." : locale === "fr" ? "Trouvez du merchandising adapté à vos besoins, à votre quantité et à votre budget." : "Encontre produtos de merchandising compatíveis com a sua necessidade, quantidade e orçamento.");
...
export default async function SmartMerchPage({ searchParams }: SmartMerchPageProps) {
  ...
  const copy = (locale === "es" ? ({ back: "Volver al inicio", title: "Encuentra el merchandising adecuado en segundos.", intro: "No busques entre miles de productos. Cu\u00E9ntanos qu\u00E9 necesitas.", selection: "Selecci\u00F3n 360 para tu campa\u00F1a", compatible: "productos encontrados", units: "unidades", budget: "Presupuesto", max: "M\u00E1x.", person: "/persona", sustainable: "Sostenible", sort: "Ordenar resultados", recommended: "Recomendado", cheapest: "Precio m\u00E1s bajo", value: "Mejor relaci\u00F3n calidad-precio", sustainableSort: "Sostenible", apply: "Aplicar", noResults: "No encontramos una combinaci\u00F3n que coincida completamente", noResultsText: "Prueba a aumentar el presupuesto, reducir la cantidad o hacer la solicitud menos espec\u00EDfica.", notConfigured: "360 Smart Merch todav\u00EDa no est\u00E1 disponible", failed: "No hemos podido crear tu selecci\u00F3n", missingKey: "Smart Merch no est\u00E1 disponible en este momento. Puedes explorar el cat\u00E1logo o contactar con nuestro equipo.", retry: "Int\u00E9ntalo de nuevo en unos instantes o modifica tu solicitud." }) : locale === "de" ? ({ back: "Zur Startseite", title: "Finden Sie in Sekunden das passende Merchandising.", intro: "Durchsuchen Sie nicht Tausende Produkte. Sagen Sie uns, was Sie ben\u00F6tigen.", selection: "360-Auswahl f\u00FCr Ihre Kampagne", compatible: "passende Produkte", units: "St\u00FCck", budget: "Budget", max: "Max.", person: "/Person", sustainable: "Nachhaltig", sort: "Ergebnisse sortieren", recommended: "Empfohlen", cheapest: "Niedrigster Preis", value: "Bestes Preis-Leistungs-Verh\u00E4ltnis", sustainableSort: "Nachhaltig", apply: "Anwenden", noResults: "Keine vollst\u00E4ndig passende Kombination gefunden", noResultsText: "Erh\u00F6hen Sie das Budget, verringern Sie die Menge oder formulieren Sie die Anfrage weniger spezifisch.", notConfigured: "360 Smart Merch ist derzeit noch nicht verf\u00FCgbar", failed: "Ihre Auswahl konnte nicht erstellt werden", missingKey: "Smart Merch ist derzeit nicht verf\u00FCgbar. Sie k\u00F6nnen den Katalog durchsuchen oder unser Team kontaktieren.", retry: "Versuchen Sie es in K\u00FCrze erneut oder \u00E4ndern Sie Ihre Anfrage." }) : locale === "it" ? ({ back: "Torna alla pagina iniziale", title: "Trova il merchandising giusto in pochi secondi.", intro: "Non cercare tra migliaia di prodotti. Dicci cosa ti serve.", selection: "Selezione 360 per la tua campagna", compatible: "prodotti corrispondenti", units: "unit\u00E0", budget: "Budget", max: "Max.", person: "/persona", sustainable: "Sostenibile", sort: "Ordina i risultati", recommended: "Consigliato", cheapest: "Prezzo pi\u00F9 basso", value: "Miglior rapporto qualit\u00E0-prezzo", sustainableSort: "Sostenibile", apply: "Applica", noResults: "Non abbiamo trovato una combinazione pienamente corrispondente", noResultsText: "Prova ad aumentare il budget, ridurre la quantit\u00E0 o rendere la richiesta meno specifica.", notConfigured: "360 Smart Merch non \u00E8 ancora disponibile", failed: "Non \u00E8 stato possibile creare la tua selezione", missingKey: "Smart Merch non \u00E8 disponibile al momento. Puoi esplorare il catalogo o contattare il nostro team.", retry: "Riprova tra poco oppure modifica la richiesta." }) : locale === "en" ? { back: "Back to homepage", title: "Find the right merchandise in seconds.", intro: "Do not search through thousands of products. Tell us what you need.", selection: "360 selection for your campaign", compatible: "matching products", units: "units", budget: "Budget", max: "Max.", person: "/person", sustainable: "Sustainable", sort: "Sort results", recommended: "Recommended", cheapest: "Lowest price", value: "Best value", sustainableSort: "Sustainable", apply: "Apply", noResults: "We could not find a fully matching combination", noResultsText: "Try increasing the budget, reducing the quantity or making the request less specific.", notConfigured: "360 Smart Merch is not configured yet", failed: "We could not create your selection", missingKey: "Add the OpenAI key to the environment variables and publish the project again.", retry: "Please try again in a moment or revise your request." } : locale === "fr" ? { back: "Retour à l’accueil", title: "Trouvez le bon merchandising en quelques secondes.", intro: "Ne parcourez pas des milliers de produits. Indiquez-nous vos besoins.", selection: "Sélection 360 pour votre campagne", compatible: "produits compatibles", units: "unités", budget: "Budget", max: "Max.", person: "/personne", sustainable: "Durable", sort: "Trier les résultats", recommended: "Recommandés", cheapest: "Prix le plus bas", value: "Meilleur rapport qualité-prix", sustainableSort: "Durables", apply: "Appliquer", noResults: "Aucune combinaison ne correspond entièrement", noResultsText: "Essayez d’augmenter le budget, de réduire la quantité ou de simplifier la demande.", notConfigured: "360 Smart Merch n’est pas encore configuré", failed: "Impossible de créer votre sélection", missingKey: "Ajoutez la clé OpenAI aux variables d’environnement puis republiez le projet.", retry: "Veuillez réessayer dans quelques instants ou reformuler votre demande." } : { back: "Voltar à página inicial", title: "Encontre o merchandising certo em segundos.", intro: "Não procure entre milhares de brindes. Diga-nos o que precisa.", selection: "Seleção 360 para a sua campanha", compatible: "produtos compatíveis", units: "unidades", budget: "Orçamento", max: "Máx.", person: "/pessoa", sustainable: "Sustentável", sort: "Ordenar resultados", recommended: "Recomendados", cheapest: "Mais económicos", value: "Melhor relação qualidade/preço", sustainableSort: "Sustentáveis", apply: "Aplicar", noResults: "Não encontrámos uma combinação totalmente compatível", noResultsText: "Experimente aumentar o orçamento, reduzir a quantidade ou tornar o pedido menos específico.", notConfigured: "O 360 Smart Merch ainda não está configurado", failed: "Não foi possível criar a seleção", missingKey: "Adicione a chave da OpenAI às variáveis de ambiente e publique novamente o projeto.", retry: "Tente novamente dentro de alguns instantes ou reformule o pedido." });

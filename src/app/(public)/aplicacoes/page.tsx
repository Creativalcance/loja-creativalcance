...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = (locale === "es" ? ("Aplicaciones del merchandising y productos promocionales personalizados") : locale === "de" ? ("Einsatzbereiche f\u00FCr Merchandising und personalisierte Werbeartikel") : locale === "it" ? ("Applicazioni del merchandising e prodotti promozionali personalizzati") : locale === "en" ? "Merchandise applications and custom promotional products" : locale === "fr" ? "Applications de merchandising et objets personnalisés" : "Aplicações de merchandising e brindes personalizados");
  const description = (locale === "es" ? ("Explora soluciones de merchandising para kits de bienvenida, eventos, congresos, campa\u00F1as navide\u00F1as y empleados.") : locale === "de" ? ("Entdecken Sie Merchandising-L\u00F6sungen f\u00FCr Willkommenspakete, Veranstaltungen, Konferenzen, Weihnachtskampagnen und Mitarbeitende.") : locale === "it" ? ("Esplora soluzioni di merchandising per kit di benvenuto, eventi, congressi, campagne natalizie e dipendenti.") : locale === "en" ? "Explore merchandise solutions for welcome kits, events, conferences, Christmas campaigns and employees." : locale === "fr" ? "Explorez des solutions pour les welcome kits, événements, congrès, campagnes de Noël et collaborateurs." : "Explore soluções de merchandising para welcome kits, eventos, congressos, Natal, colaboradores e outras necessidades empresariais.");
...
export default async function ApplicationsPage() {
  const locale = await getCurrentLocale();
  const copy = (locale === "es" ? ({ back: "Volver al inicio", eyebrow: "Soluciones por necesidad", title: "Aplicaciones del merchandising", intro: "Encuentra ideas, criterios de selecci\u00F3n y productos para incorporaciones, eventos, congresos, campa\u00F1as navide\u00F1as y participaci\u00F3n de empleados.", explore: "Explorar soluci\u00F3n", unsure: "\u00BFNo sabes qu\u00E9 producto elegir?", unsureText: "Describe lo que necesitas, la cantidad, el presupuesto o el plazo y utiliza Smart Merch para explorar el cat\u00E1logo.", try: "Probar Smart Merch" }) : locale === "de" ? ({ back: "Zur Startseite", eyebrow: "L\u00F6sungen nach Bedarf", title: "Merchandising-Einsatzbereiche", intro: "Finden Sie Ideen, Auswahlkriterien und Produkte f\u00FCr Onboarding, Veranstaltungen, Konferenzen, Weihnachtskampagnen und Mitarbeiterbindung.", explore: "L\u00F6sung ansehen", unsure: "Sie wissen nicht, welches Produkt Sie w\u00E4hlen sollen?", unsureText: "Beschreiben Sie Ihren Bedarf, die Menge, Ihr Budget oder den Termin und erkunden Sie den Katalog mit Smart Merch.", try: "Smart Merch ausprobieren" }) : locale === "it" ? ({ back: "Torna alla pagina iniziale", eyebrow: "Soluzioni per esigenza", title: "Applicazioni del merchandising", intro: "Trova idee, criteri di scelta e prodotti per l'inserimento dei dipendenti, eventi, congressi, campagne natalizie e coinvolgimento del personale.", explore: "Esplora la soluzione", unsure: "Non sai quale prodotto scegliere?", unsureText: "Descrivi le tue esigenze, la quantit\u00E0, il budget o la scadenza e usa Smart Merch per esplorare il catalogo.", try: "Prova Smart Merch" }) : locale === "en" ? { back: "Back to homepage", eyebrow: "Solutions by requirement", title: "Merchandise applications", intro: "Find ideas, selection criteria and products for onboarding, events, conferences, Christmas campaigns and employee engagement.", explore: "Explore solution", unsure: "Not sure which product to choose?", unsureText: "Describe your requirement, quantity, budget or deadline and use Smart Merch to explore the catalogue.", try: "Try Smart Merch" } : locale === "fr" ? { back: "Retour à l’accueil", eyebrow: "Solutions par besoin", title: "Applications du merchandising", intro: "Découvrez des idées, critères et produits pour l’accueil, les événements, les congrès, Noël et l’engagement des collaborateurs.", explore: "Explorer la solution", unsure: "Vous ne savez pas quel produit choisir ?", unsureText: "Décrivez votre besoin, quantité, budget ou délai et utilisez Smart Merch pour explorer le catalogue.", try: "Essayer Smart Merch" } : { back: "Voltar à página inicial", eyebrow: "Soluções por necessidade", title: "Aplicações de merchandising", intro: "Encontre ideias, critérios de escolha e produtos de acordo com o objetivo da sua ação: receber colaboradores, organizar um evento, preparar um congresso ou criar uma campanha de Natal.", explore: "Explorar solução", unsure: "Ainda não sabe que produto escolher?", unsureText: "Descreva a necessidade, quantidade, orçamento ou prazo e use o Smart Merch para explorar o catálogo.", try: "Experimentar Smart Merch" });

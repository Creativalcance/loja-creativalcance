...
export default async function CheckoutShippingPage() {
  ...
  const text = (locale === "es" ? ({
    back: "Volver al destino", destination: "Destino", complete: "Completado", shipping: "Env\u00EDo", shippingTime: "M\u00E9todo y plazo", payment: "Pago", reviewPayment: "Revisi\u00F3n y pago", step: "Paso 2 de 3", intro: "Elige el m\u00E9todo de env\u00EDo, confirma el plazo estimado y a\u00F1ade las referencias necesarias para la entrega.", address: "Direcci\u00F3n de entrega", change: "Cambiar destino", order: "Pedido", summary: "Resumen", configured: "Personalizaci\u00F3n configurada", location: "Ubicaci\u00F3n", technique: "T\u00E9cnica", confirm: "Por confirmar", products: "Productos", personalization: "Personalizaci\u00F3n", setup: "Preparaci\u00F3n", extras: "Extras", selecting: "Por seleccionar", current: "Total actual", before: "Importe sin env\u00EDo ni IVA.", next: "Siguiente paso", nextHelp: "En el pago podr\u00E1s revisar todos los importes, confirmar los datos de facturaci\u00F3n y completar el pago seguro.", units: "unidades",
}) : locale === "de" ? ({
    back: "Zur\u00FCck zur Lieferadresse", destination: "Lieferadresse", complete: "Abgeschlossen", shipping: "Versand", shippingTime: "Versandart und Lieferzeit", payment: "Zahlung", reviewPayment: "Pr\u00FCfung und Zahlung", step: "Schritt 2 von 3", intro: "W\u00E4hlen Sie die Versandart, best\u00E4tigen Sie die voraussichtliche Lieferzeit und erg\u00E4nzen Sie die erforderlichen Lieferangaben.", address: "Lieferanschrift", change: "Lieferadresse \u00E4ndern", order: "Bestellung", summary: "Zusammenfassung", configured: "Personalisierung konfiguriert", location: "Position", technique: "Technik", confirm: "Noch zu best\u00E4tigen", products: "Produkte", personalization: "Personalisierung", setup: "Einrichtung", extras: "Extras", selecting: "Noch auszuw\u00E4hlen", current: "Aktueller Gesamtbetrag", before: "Betrag ohne Versand und MwSt.", next: "N\u00E4chster Schritt", nextHelp: "Beim Bezahlen k\u00F6nnen Sie alle Betr\u00E4ge pr\u00FCfen, die Rechnungsangaben best\u00E4tigen und die sichere Zahlung abschlie\u00DFen.", units: "St\u00FCck",
}) : locale === "it" ? ({
    back: "Torna alla destinazione", destination: "Destinazione", complete: "Completato", shipping: "Spedizione", shippingTime: "Metodo e tempi", payment: "Pagamento", reviewPayment: "Riepilogo e pagamento", step: "Passaggio 2 di 3", intro: "Scegli il metodo di spedizione, conferma i tempi stimati e aggiungi i riferimenti necessari per la consegna.", address: "Indirizzo di consegna", change: "Modifica la destinazione", order: "Ordine", summary: "Riepilogo", configured: "Personalizzazione configurata", location: "Posizione", technique: "Tecnica", confirm: "Da confermare", products: "Prodotti", personalization: "Personalizzazione", setup: "Preparazione", extras: "Extra", selecting: "Da selezionare", current: "Totale attuale", before: "Importo esclusi spedizione e IVA.", next: "Passaggio successivo", nextHelp: "Al pagamento puoi verificare tutti gli importi, confermare i dati di fatturazione e completare il pagamento sicuro.", units: "unit\u00E0",
}) : locale === "en" ? {
  ...
  if (!user) {
    redirect(`${localizePath("/login", locale)}?next=${encodeURIComponent(localizePath("/checkout/expedicao", locale))}`);
  }

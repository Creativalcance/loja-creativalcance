...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = (locale === "es" ? ("Merchandising personalizado por sector") : locale === "de" ? ("Personalisiertes Merchandising nach Branche") : locale === "it" ? ("Merchandising personalizzato per settore") : locale === "en" ? "Custom merchandise by industry" : locale === "fr" ? "Merchandising personnalisé par secteur" : "Merchandising personalizado por indústria");
  const description = (locale === "es" ? ("Explora merchandising para hosteler\u00EDa, universidades, startups, tecnolog\u00EDa, salud, turismo y restauraci\u00F3n.") : locale === "de" ? ("Entdecken Sie Merchandising f\u00FCr Hotellerie, Hochschulen, Start-ups, Technologie, Gesundheit, Tourismus und Gastronomie.") : locale === "it" ? ("Esplora merchandising per ospitalit\u00E0, universit\u00E0, startup, tecnologia, sanit\u00E0, turismo e ristorazione.") : locale === "en" ? "Explore merchandise for hospitality, universities, startups, technology, healthcare, tourism and restaurants." : locale === "fr" ? "Explorez le merchandising pour l’hôtellerie, les universités, les startups, la technologie, la santé, le tourisme et la restauration." : "Explore soluções de merchandising para hotelaria, universidades, startups, tecnologia, saúde, turismo e restauração.");

    ...
    <main className="min-h-screen bg-neutral-50 px-4 py-8 sm:px-6">
      <section className="mx-auto max-w-5xl">
        ...
        <p className="mt-3 text-neutral-600">
          Fica fora da sincronização do fornecedor e, depois do pagamento, é
          encaminhado para a equipa 360.
        </p>
        <p className="mt-3 text-sm text-neutral-500">
          Precisas de uma categoria nova?{" "}
          <Link
        ...
        <form
          ...
          className="mt-8 grid gap-6 rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm md:grid-cols-2"
        >
            ...
            >
              ...
              {categories.map((category) => (
                <option key={category.id} value={category.id}>
                  {category.name}
                  {category.catalog_source === "manual" ? " · 360" : ""}
                </option>
              ))}
            </select>
          </label>
          ...
          <label className={label}>
            Material
            <input className={input} name="material" />
          </label>
          <label className={label + " md:col-span-2"}>
            Descrição curta
            <textarea className={input} name="shortDescription" rows={2} />
          </label>
          <label className={label + " md:col-span-2"}>
            Descrição completa
          ...
          <label className={label}>
            Título SEO
            <input className={input} name="seoTitle" />
          </label>
          <label className={label}>
            Descrição SEO
            <textarea className={input} name="seoDescription" rows={2} />
          </label>
          ...
          <div className="md:col-span-2 flex justify-end">
            <button className="rounded-2xl bg-orange-600 px-6 py-3 font-semibold text-white">
              Criar produto
            </button>
          </div>
        </form>

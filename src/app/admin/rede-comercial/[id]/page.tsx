            ...
            <Panel title={`Contactos angariados · ${data.contactCount}`}>
              ...
              {!data.contacts.length && (
                <p className="text-sm text-slate-500">
                  O comercial pode registar e acompanhar contactos na sua área.
                </p>
              )}
            </Panel>
          </div>
          <div className="space-y-7">
            <Panel title="Acesso à área comercial">
              <p className="mb-4 text-sm leading-6 text-slate-600">
                O convite permite definir a palavra-passe. O comercial recebe a
                sua área no idioma configurado e só pode consultar a sua
                carteira.
              </p>
              <SalesActionForm
            ...
            <Panel title={`Encomendas e comissões · ${data.commissionCount}`}>
              <p className="mb-4 text-xs leading-5 text-slate-500">
                ...
                concluída e prazo cumprido. Aprovar não efetua uma transferência
                bancária.
              </p>

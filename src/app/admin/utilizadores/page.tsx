...
type Row={id:string;full_name:string|null;email:string;phone:string|null;company_name:string|null;tax_id:string|null;role:"customer"|"admin"|"sales";is_active:boolean;created_at:string};

...
function PurchasePanel({
  ...
  const panelText =
    ...
    priceTiers: "Escalones de precio",
    quantity: "Cantidad",
    unitPrice: "Precio / unidad",
    pricePending: "El precio se mostrar\u00E1 antes de completar el pedido.",
    orderTitle: "Realiza tu pedido",
    orderWithSizes: "Elige primero un color y despu\u00E9s introduce la cantidad para la talla que necesitas.",
    orderWithoutSizes: "Introduce la cantidad para el color que necesitas. Puedes a\u00F1adirlo directamente al carrito o continuar a la personalizaci\u00F3n.",
    selectedColour: "Color seleccionado",
    mockupReady: "Maqueta lista",
    mockupHelp: "La personalizaci\u00F3n se vincular\u00E1 a esta l\u00EDnea del pedido.",
    saved: "Guardado",
    location: "Ubicaci\u00F3n",
    technique: "T\u00E9cnica",
    logo: "Logotipo",
    toConfirm: "Por confirmar",
    noLogo: "Todav\u00EDa sin cargar",
    editMockup: "Editar o crear una nueva maqueta",
    staleMockup: "El color, la talla o la cantidad han cambiado. La maqueta anterior ya no est\u00E1 vinculada. Crea una nueva maqueta antes de a\u00F1adir la personalizaci\u00F3n al carrito.",
    inStock: "unidades en stock",
    nextDelivery: "Pr\u00F3xima entrega:",
    futureStock: "Este pedido incluye unidades de stock futuro. Entregas previstas:",
    summary: "Resumen del pedido",
    size: "Tama\u00F1o",
    preparation: "Preparaci\u00F3n",
    total: "Total estimado",
    disclaimer: "Precios sin IVA ni env\u00EDo. La disponibilidad, personalizaci\u00F3n e importe final se confirman antes de completar el pedido.",
    viewCart: "Ver carrito",
    preparing: "Preparando personalizaci\u00F3n...",
    continuePersonalization: "Continuar a la personalizaci\u00F3n",
    adding: "A\u00F1adiendo...",
    addPersonalized: "A\u00F1adir pedido personalizado",
    addWithout: "A\u00F1adir sin personalizaci\u00F3n",
}) : locale === "de" ? ({
    product: "Produkt",
    from: "Ab",
    perUnit: "/ St\u00FCck",
    ...
    priceTiers: "Preisstaffeln",
    quantity: "Menge",
    unitPrice: "Preis / St\u00FCck",
    pricePending: "Der Preis wird vor Abschluss der Bestellung angezeigt.",
    orderTitle: "Bestellung aufgeben",
    orderWithSizes: "W\u00E4hlen Sie zuerst eine Farbe und geben Sie dann die Menge f\u00FCr die gew\u00FCnschte Gr\u00F6\u00DFe ein.",
    orderWithoutSizes: "Geben Sie die Menge f\u00FCr die gew\u00FCnschte Farbe ein. Sie k\u00F6nnen das Produkt direkt in den Warenkorb legen oder mit der Personalisierung fortfahren.",
    selectedColour: "Ausgew\u00E4hlte Farbe",
    mockupReady: "Vorschau bereit",
    mockupHelp: "Die Personalisierung wird mit dieser Bestellposition verkn\u00FCpft.",
    saved: "Gespeichert",
    location: "Position",
    technique: "Technik",
    logo: "Logo",
    toConfirm: "Noch zu best\u00E4tigen",
    noLogo: "Noch nicht hochgeladen",
    editMockup: "Vorschau bearbeiten oder neu erstellen",
    staleMockup: "Farbe, Gr\u00F6\u00DFe oder Menge haben sich ge\u00E4ndert. Die bisherige Vorschau ist nicht mehr verkn\u00FCpft. Erstellen Sie eine neue Vorschau, bevor Sie die Personalisierung zum Warenkorb hinzuf\u00FCgen.",
    inStock: "St\u00FCck auf Lager",
    nextDelivery: "N\u00E4chste Lieferung:",
    futureStock: "Diese Bestellung enth\u00E4lt St\u00FCckzahlen aus k\u00FCnftigem Bestand. Erwartete Lieferungen:",
    summary: "Bestell\u00FCbersicht",
    size: "Gr\u00F6\u00DFe",
    preparation: "Einrichtung",
    total: "Gesch\u00E4tzter Gesamtbetrag",
    disclaimer: "Preise ohne MwSt. und Versand. Verf\u00FCgbarkeit, Personalisierung und endg\u00FCltiger Betrag werden vor Bestellabschluss best\u00E4tigt.",
    viewCart: "Warenkorb ansehen",
    preparing: "Personalisierung wird vorbereitet...",
    continuePersonalization: "Weiter zur Personalisierung",
    adding: "Wird hinzugef\u00FCgt...",
    addPersonalized: "Personalisierte Bestellung hinzuf\u00FCgen",
    addWithout: "Ohne Personalisierung hinzuf\u00FCgen",
}) : locale === "it" ? ({
    product: "Prodotto",
    from: "Da",
    perUnit: "/ unit\u00E0",
    minQuantity: "Quantit\u00E0 minima",
    stockAvailable: "Disponibilit\u00E0 a magazzino",
    personalization: "Personalizzazione",
    available: "Disponibile",
    notIncluded: "Non incluso",
    priceTiers: "Fasce di prezzo",
    quantity: "Quantit\u00E0",
    unitPrice: "Prezzo / unit\u00E0",
    pricePending: "Il prezzo verr\u00E0 mostrato prima del completamento dell'ordine.",
    orderTitle: "Effettua l'ordine",
    orderWithSizes: "Scegli prima un colore, poi inserisci la quantit\u00E0 per la taglia desiderata.",
    orderWithoutSizes: "Inserisci la quantit\u00E0 per il colore desiderato. Puoi aggiungerlo direttamente al carrello o continuare con la personalizzazione.",
    selectedColour: "Colore selezionato",
    mockupReady: "Bozza pronta",
    mockupHelp: "La personalizzazione verr\u00E0 collegata a questa riga dell'ordine.",
    saved: "Salvato",
    location: "Posizione",
    technique: "Tecnica",
    logo: "Logo",
    toConfirm: "Da confermare",
    noLogo: "Non ancora caricato",
    editMockup: "Modifica o crea una nuova bozza",
    staleMockup: "Colore, taglia o quantit\u00E0 sono cambiati. La bozza precedente non \u00E8 pi\u00F9 collegata. Crea una nuova bozza prima di aggiungere la personalizzazione al carrello.",
    inStock: "unit\u00E0 a magazzino",
    nextDelivery: "Prossima consegna:",
    futureStock: "Questo ordine include unit\u00E0 da disponibilit\u00E0 futura. Consegne previste:",
    summary: "Riepilogo dell'ordine",
    size: "Dimensione",
    preparation: "Preparazione",
    total: "Totale stimato",
    disclaimer: "Prezzi esclusi IVA e spedizione. Disponibilit\u00E0, personalizzazione e importo finale vengono confermati prima del completamento dell'ordine.",
    viewCart: "Vedi carrello",
    preparing: "Preparazione della personalizzazione...",
    continuePersonalization: "Continua alla personalizzazione",
    adding: "Aggiunta in corso...",
    addPersonalized: "Aggiungi ordine personalizzato",
    addWithout: "Aggiungi senza personalizzazione",
}) : locale === "en"
      ? {
          product: "Product",
          from: "From",

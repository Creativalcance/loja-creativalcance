...
export default function CookieConsentManager({ locale }: { locale: SiteLocale }) {
  ...
  const copy = (locale === "es" ? ({ title: "Tus opciones de privacidad", text: "Utilizamos cookies esenciales para la tienda, el carrito, la autenticaci\u00F3n y los pagos seguros. Con tu permiso, tambi\u00E9n utilizamos cookies de an\u00E1lisis y marketing.", policy: "Pol\u00EDtica de cookies", all: "Aceptar todas", decline: "Rechazar", essential: "Solo esenciales" }) : locale === "de" ? ({ title: "Ihre Datenschutzeinstellungen", text: "Wir verwenden notwendige Cookies f\u00FCr den Shop, den Warenkorb, die Anmeldung und sichere Zahlungen. Mit Ihrer Einwilligung nutzen wir au\u00DFerdem Analyse- und Marketing-Cookies.", policy: "Cookie-Richtlinie", all: "Alle akzeptieren", decline: "Ablehnen", essential: "Nur notwendige" }) : locale === "it" ? ({ title: "Le tue scelte sulla privacy", text: "Usiamo cookie essenziali per il negozio, il carrello, l'autenticazione e i pagamenti sicuri. Con il tuo consenso, usiamo anche cookie di analisi e marketing.", policy: "Informativa sui cookie", all: "Accetta tutti", decline: "Rifiuta", essential: "Solo essenziali" }) : locale === "en"

...
export default function SmartMerchResultCard({ result, locale }: { result: SmartMerchResult; locale: SiteLocale }) {
  const text = (locale === "es" ? ({ noImage: "No hay imagen disponible", match: "coincidencia", colour: "Color seleccionado", sustainable: "Sostenible", customizable: "Personalizable", unit: "Producto / unidad", total: "Total de productos", quote: "Bajo consulta", calculate: "Por calcular", stock: "unidades disponibles", delivery: "Entrega estimada", withCustomization: "Incluye la personalizaci\u00F3n m\u00E1s r\u00E1pida disponible", withoutCustomization: "Producto sin personalizaci\u00F3n", estimate: "Solo estimaci\u00F3n, sujeta a la aprobaci\u00F3n de la maqueta, la personalizaci\u00F3n seleccionada y el plazo de env\u00EDo.", why: "Por qu\u00E9 lo recomendamos", view: "Ver producto" }) : locale === "de" ? ({ noImage: "Kein Bild verf\u00FCgbar", match: "\u00DCbereinstimmung", colour: "Ausgew\u00E4hlte Farbe", sustainable: "Nachhaltig", customizable: "Personalisierbar", unit: "Produkt / St\u00FCck", total: "Produktgesamtbetrag", quote: "Auf Anfrage", calculate: "Wird berechnet", stock: "St\u00FCck verf\u00FCgbar", delivery: "Voraussichtliche Lieferung", withCustomization: "Enth\u00E4lt die schnellste verf\u00FCgbare Personalisierung", withoutCustomization: "Produkt ohne Personalisierung", estimate: "Nur eine Sch\u00E4tzung, abh\u00E4ngig von Druckfreigabe, gew\u00E4hlter Personalisierung und Versanddauer.", why: "Warum wir es empfehlen", view: "Produkt ansehen" }) : locale === "it" ? ({ noImage: "Nessuna immagine disponibile", match: "corrispondenza", colour: "Colore selezionato", sustainable: "Sostenibile", customizable: "Personalizzabile", unit: "Prodotto / unit\u00E0", total: "Totale prodotti", quote: "Su richiesta", calculate: "Da calcolare", stock: "unit\u00E0 disponibili", delivery: "Consegna stimata", withCustomization: "Include la personalizzazione pi\u00F9 rapida disponibile", withoutCustomization: "Prodotto senza personalizzazione", estimate: "Solo una stima, soggetta all'approvazione della bozza, alla personalizzazione selezionata e ai tempi di spedizione.", why: "Perch\u00E9 lo consigliamo", view: "Vedi prodotto" }) : locale === "en" ? { noImage: "No image available", match: "match", colour: "Selected colour", sustainable: "Sustainable", customizable: "Customisable", unit: "Product / unit", total: "Product total", quote: "On request", calculate: "To be calculated", stock: "units available", delivery: "Estimated delivery", withCustomization: "Includes the fastest available customisation", withoutCustomization: "Product without customisation", estimate: "Estimate only, subject to mock-up approval, selected customisation and shipping time.", why: "Why we recommend it", view: "View product" } : locale === "fr" ? { noImage: "Image indisponible", match: "compatible", colour: "Couleur sélectionnée", sustainable: "Durable", customizable: "Personnalisable", unit: "Produit / unité", total: "Total produit", quote: "Sur demande", calculate: "À calculer", stock: "unités disponibles", delivery: "Livraison estimée", withCustomization: "Inclut la personnalisation disponible la plus rapide", withoutCustomization: "Produit sans personnalisation", estimate: "Estimation uniquement, selon l’approbation de la maquette, la personnalisation et le transport.", why: "Pourquoi nous le recommandons", view: "Voir le produit" } : { noImage: "Sem imagem disponível", match: "compatível", colour: "Cor selecionada", sustainable: "Sustentável", customizable: "Personalizável", unit: "Produto/unidade", total: "Produto total", quote: "Sob consulta", calculate: "Por calcular", stock: "un. disponíveis", delivery: "Entrega estimada", withCustomization: "Considera a personalização mais rápida disponível", withoutCustomization: "Produto sem personalização incluída", estimate: "Data meramente estimativa, dependente da aprovação da maquete, da personalização e do transporte.", why: "Porque recomendamos", view: "Ver produto" });
  return (

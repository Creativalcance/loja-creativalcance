...
export default function NewsletterSignup({ locale }: { locale: SiteLocale }) {
  ...
  const copy = (locale === "es" ? ({ eyebrow: "Novedades 360", title: "Ideas, productos y oportunidades para tu marca", intro: "Recibe novedades seleccionadas, inspiraci\u00F3n y contenidos \u00FAtiles sobre merchandising. Sin ruido.", name: "Nombre", email: "Direcci\u00F3n de correo electr\u00F3nico", button: "Suscribirse", pending: "Suscribiendo...", consent: "Acepto recibir la newsletter de 360 Merchandising y he le\u00EDdo la", privacy: "Pol\u00EDtica de privacidad" }) : locale === "de" ? ({ eyebrow: "360-Neuigkeiten", title: "Ideen, Produkte und M\u00F6glichkeiten f\u00FCr Ihre Marke", intro: "Erhalten Sie ausgew\u00E4hlte Neuheiten, Inspiration und n\u00FCtzliche Merchandising-Inhalte. Ohne unn\u00F6tige Nachrichten.", name: "Name", email: "E-Mail-Adresse", button: "Abonnieren", pending: "Anmeldung l\u00E4uft...", consent: "Ich m\u00F6chte den Newsletter von 360 Merchandising erhalten und habe die folgende Erkl\u00E4rung gelesen:", privacy: "Datenschutzerkl\u00E4rung" }) : locale === "it" ? ({ eyebrow: "Novit\u00E0 360", title: "Idee, prodotti e opportunit\u00E0 per il tuo marchio", intro: "Ricevi novit\u00E0 selezionate, ispirazione e contenuti utili sul merchandising. Senza messaggi superflui.", name: "Nome", email: "Indirizzo e-mail", button: "Iscriviti", pending: "Iscrizione in corso...", consent: "Acconsento a ricevere la newsletter di 360 Merchandising e ho letto la", privacy: "Informativa sulla privacy" }) : locale === "en"

...
es: { groups: { commercial: "Soluciones empresariales", budget: "Soluciones por presupuesto", quantity: "Soluciones por cantidad", occasion: "Soluciones por ocasi\u00F3n" }, back: "Volver a las soluciones", moreTitle: "\u00BFNecesitas combinar m\u00E1s criterios?", moreText: "Smart Merch combina necesidad, cantidad, presupuesto y plazo para acotar tu b\u00FAsqueda antes de configurar un producto.", smart: "Probar Smart Merch", selection: "Selecci\u00F3n empresarial", productTitle: "Productos que coinciden con el filtro inicial de esta p\u00E1gina", search: "Buscar en el cat\u00E1logo", budget: "El filtro de presupuesto utiliza los precios base del cat\u00E1logo. No es un presupuesto final y no incluye autom\u00E1ticamente la personalizaci\u00F3n. Confirma el importe final para tu cantidad y configuraci\u00F3n.", emptyTitle: "No hay suficientes sugerencias para este filtro", emptyText: "Es posible que el cat\u00E1logo no contenga actualmente productos que cumplan este criterio. Contin\u00FAa con la b\u00FAsqueda o ajusta los criterios en Smart Merch.", before: "Antes de decidir", compareTitle: "Compara la soluci\u00F3n completa, no solo el filtro inicial", compareText: "El presupuesto, la cantidad y la ocasi\u00F3n acotan las opciones, pero la decisi\u00F3n final debe incluir stock, materiales, variante, personalizaci\u00F3n, plazos y uso previsto.", choiceGuide: "Gu\u00EDa de selecci\u00F3n", budgetGuide: "Gu\u00EDa de presupuesto", angle: "Explora otro enfoque", angleTitle: "Aplicaci\u00F3n, sector o t\u00E9cnica", angleText: "Si el presupuesto o la cantidad no son el criterio principal, explora por aplicaci\u00F3n, sector o m\u00E9todo de personalizaci\u00F3n.", applications: "Aplicaciones", industries: "Sectores", customization: "Personalizaci\u00F3n", faq: "Preguntas frecuentes", related: "Soluciones relacionadas", view: "Ver soluci\u00F3n" },
de: { groups: { commercial: "Unternehmensl\u00F6sungen", budget: "L\u00F6sungen nach Budget", quantity: "L\u00F6sungen nach Menge", occasion: "L\u00F6sungen nach Anlass" }, back: "Zur\u00FCck zu den L\u00F6sungen", moreTitle: "M\u00F6chten Sie weitere Kriterien kombinieren?", moreText: "Smart Merch kombiniert Bedarf, Menge, Budget und Termin, um Ihre Suche vor der Produktkonfiguration einzugrenzen.", smart: "Smart Merch ausprobieren", selection: "Auswahl f\u00FCr Unternehmen", productTitle: "Produkte passend zum Ausgangsfilter dieser Seite", search: "Katalog durchsuchen", budget: "Der Budgetfilter verwendet Kataloggrundpreise. Er ist kein endg\u00FCltiges Angebot und enth\u00E4lt nicht automatisch die Personalisierung. Best\u00E4tigen Sie den Endbetrag f\u00FCr Ihre Menge und Konfiguration.", emptyTitle: "Nicht gen\u00FCgend Vorschl\u00E4ge f\u00FCr diesen Filter", emptyText: "Der Katalog enth\u00E4lt derzeit m\u00F6glicherweise keine Produkte f\u00FCr dieses Kriterium. Setzen Sie die Suche fort oder passen Sie Ihre Kriterien in Smart Merch an.", before: "Vor der Entscheidung", compareTitle: "Vergleichen Sie die gesamte L\u00F6sung, nicht nur den Ausgangsfilter", compareText: "Budget, Menge und Anlass grenzen die Optionen ein. Bei Ihrer Entscheidung sollten Sie aber auch Bestand, Materialien, Variante, Personalisierung, Termine und Verwendungszweck ber\u00FCcksichtigen.", choiceGuide: "Auswahlratgeber", budgetGuide: "Budgetratgeber", angle: "Eine andere Perspektive entdecken", angleTitle: "Einsatzbereich, Branche oder Technik", angleText: "Wenn Budget oder Menge nicht ausschlaggebend sind, suchen Sie nach Einsatzbereich, Branche oder Personalisierungsmethode.", applications: "Einsatzbereiche", industries: "Branchen", customization: "Personalisierung", faq: "H\u00E4ufige Fragen", related: "Verwandte L\u00F6sungen", view: "L\u00F6sung ansehen" },
it: { groups: { commercial: "Soluzioni aziendali", budget: "Soluzioni per budget", quantity: "Soluzioni per quantit\u00E0", occasion: "Soluzioni per occasione" }, back: "Torna alle soluzioni", moreTitle: "Hai bisogno di combinare pi\u00F9 criteri?", moreText: "Smart Merch combina esigenza, quantit\u00E0, budget e scadenza per restringere la ricerca prima di configurare un prodotto.", smart: "Prova Smart Merch", selection: "Selezione aziendale", productTitle: "Prodotti corrispondenti al filtro iniziale di questa pagina", search: "Cerca nel catalogo", budget: "Il filtro di budget usa i prezzi base del catalogo. Non \u00E8 un preventivo finale e non include automaticamente la personalizzazione. Conferma l'importo finale per la tua quantit\u00E0 e configurazione.", emptyTitle: "Suggerimenti insufficienti per questo filtro", emptyText: "Il catalogo potrebbe non contenere attualmente prodotti corrispondenti a questo criterio. Continua la ricerca o modifica i criteri in Smart Merch.", before: "Prima di decidere", compareTitle: "Confronta la soluzione completa, non solo il filtro iniziale", compareText: "Budget, quantit\u00E0 e occasione restringono le opzioni, ma la decisione finale deve considerare disponibilit\u00E0, materiali, variante, personalizzazione, tempi e uso previsto.", choiceGuide: "Guida alla scelta", budgetGuide: "Guida al budget", angle: "Esplora un'altra prospettiva", angleTitle: "Applicazione, settore o tecnica", angleText: "Se budget o quantit\u00E0 non sono il criterio principale, esplora per applicazione, settore o metodo di personalizzazione.", applications: "Applicazioni", industries: "Settori", customization: "Personalizzazione", faq: "Domande frequenti", related: "Soluzioni correlate", view: "Vedi soluzione" },
};

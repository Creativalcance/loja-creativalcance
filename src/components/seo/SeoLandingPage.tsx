...
export default function SeoLandingPage({
  ...
  const text = (locale === "es" ? ({ applications: "aplicaciones", industries: "sectores", back: "Volver a", thinking: "\u00BFEst\u00E1s planificando para esta necesidad?", thinkingText: "Utiliza Smart Merch para combinar tipo de producto, cantidad, presupuesto y plazo, o explora las sugerencias de esta p\u00E1gina.", trySmart: "Probar Smart Merch", budget: "Por presupuesto y cantidad", relatedProducts: "Productos relacionados", suggestions: "Sugerencias para empezar", suggestionsText: "Esta selecci\u00F3n utiliza el cat\u00E1logo activo y t\u00E9rminos relacionados con esta necesidad. Confirma siempre stock, cantidades y personalizaci\u00F3n en la p\u00E1gina del producto.", search: "Buscar en el cat\u00E1logo", explore: "Explorar el cat\u00E1logo completo", empty: "No hay sugerencias espec\u00EDficas disponibles en este momento. Contin\u00FAa con la b\u00FAsqueda o Smart Merch.", also: "Explorar m\u00E1s", view: "Ver p\u00E1gina" }) : locale === "de" ? ({ applications: "Einsatzbereiche", industries: "Branchen", back: "Zur\u00FCck zu", thinking: "Planen Sie f\u00FCr diesen Bedarf?", thinkingText: "Kombinieren Sie mit Smart Merch Produkttyp, Menge, Budget und Termin oder entdecken Sie die Vorschl\u00E4ge auf dieser Seite.", trySmart: "Smart Merch ausprobieren", budget: "Nach Budget und Menge", relatedProducts: "Verwandte Produkte", suggestions: "Vorschl\u00E4ge zum Einstieg", suggestionsText: "Diese Auswahl nutzt den aktiven Katalog und Begriffe zu diesem Bedarf. Pr\u00FCfen Sie Bestand, Mengen und Personalisierung stets auf der Produktseite.", search: "Katalog durchsuchen", explore: "Gesamten Katalog durchsuchen", empty: "Derzeit sind keine spezifischen Vorschl\u00E4ge verf\u00FCgbar. Nutzen Sie die Suche oder Smart Merch.", also: "Mehr entdecken", view: "Seite ansehen" }) : locale === "it" ? ({ applications: "applicazioni", industries: "settori", back: "Torna a", thinking: "Stai pianificando per questa esigenza?", thinkingText: "Usa Smart Merch per combinare tipo di prodotto, quantit\u00E0, budget e scadenza oppure esplora i suggerimenti di questa pagina.", trySmart: "Prova Smart Merch", budget: "Per budget e quantit\u00E0", relatedProducts: "Prodotti correlati", suggestions: "Suggerimenti per iniziare", suggestionsText: "Questa selezione usa il catalogo attivo e termini collegati a questa esigenza. Verifica sempre disponibilit\u00E0, quantit\u00E0 e personalizzazione nella pagina del prodotto.", search: "Cerca nel catalogo", explore: "Esplora il catalogo completo", empty: "Al momento non sono disponibili suggerimenti specifici. Continua con la ricerca o Smart Merch.", also: "Esplora altro", view: "Vedi pagina" }) : locale === "en" ? { applications: "applications", industries: "industries", back: "Back to", thinking: "Planning for this requirement?", thinkingText: "Use Smart Merch to combine product type, quantity, budget and deadline, or explore the suggestions on this page.", trySmart: "Try Smart Merch", budget: "By budget and quantity", relatedProducts: "Related products", suggestions: "Suggestions to get started", suggestionsText: "This selection uses the active catalogue and terms related to this requirement. Always confirm stock, quantities and customisation on the product page.", search: "Search catalogue", explore: "Browse the full catalogue", empty: "Specific suggestions are not available right now. Continue with search or Smart Merch.", also: "Explore more", view: "View page" } : locale === "fr" ? { applications: "applications", industries: "secteurs", back: "Retour aux", thinking: "Vous préparez ce type de projet ?", thinkingText: "Utilisez Smart Merch pour croiser type de produit, quantité, budget et délai, ou consultez les suggestions de cette page.", trySmart: "Essayer Smart Merch", budget: "Par budget et quantité", relatedProducts: "Produits associés", suggestions: "Suggestions pour commencer", suggestionsText: "Cette sélection repose sur le catalogue actif et des termes liés à ce besoin. Vérifiez toujours le stock, les quantités et la personnalisation sur la fiche produit.", search: "Rechercher dans le catalogue", explore: "Explorer tout le catalogue", empty: "Aucune suggestion spécifique n’est disponible pour le moment. Continuez avec la recherche ou Smart Merch.", also: "À découvrir également", view: "Voir la page" } : { applications: "aplicações", industries: "indústrias", back: "Voltar a", thinking: "A pensar nesta necessidade?", thinkingText: "Use o Smart Merch para cruzar tipo de produto, quantidade, orçamento e prazo, ou explore as sugestões desta página.", trySmart: "Experimentar Smart Merch", budget: "Por orçamento e quantidade", relatedProducts: "Produtos relacionados", suggestions: "Sugestões para começar", suggestionsText: "A seleção abaixo é construída a partir do catálogo ativo e de termos relacionados com esta necessidade. Confirme sempre stock, quantidades e opções de personalização na página do produto.", search: "Pesquisar catálogo", explore: "Explore o catálogo completo", empty: "Não foi possível carregar sugestões específicas neste momento. Pode continuar pela pesquisa ou pelo Smart Merch.", also: "Explorar também", view: "Ver página" });

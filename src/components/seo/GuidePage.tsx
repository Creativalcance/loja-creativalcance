...
es: { back: "Volver a las gu\u00EDas", by: "Contenido de", summary: "Resumen", catalogue: "Explorar el cat\u00E1logo", products: "Productos relacionados con esta gu\u00EDa", productText: "Estas sugerencias proceden del cat\u00E1logo activo. Confirma stock, precio, cantidades y personalizaci\u00F3n en la p\u00E1gina de cada producto.", solutions: "Explorar por presupuesto y cantidad", search: "Buscar en el cat\u00E1logo", empty: "No se han podido cargar sugerencias espec\u00EDficas en este momento.", faq: "Preguntas frecuentes", continue: "Seguir explorando", read: "Leer gu\u00EDa" },
de: { back: "Zur\u00FCck zu den Ratgebern", by: "Inhalte von", summary: "Zusammenfassung", catalogue: "Katalog entdecken", products: "Produkte zu diesem Ratgeber", productText: "Diese Vorschl\u00E4ge stammen aus dem aktiven Katalog. Pr\u00FCfen Sie Bestand, Preis, Mengen und Personalisierung auf der jeweiligen Produktseite.", solutions: "Nach Budget und Menge entdecken", search: "Katalog durchsuchen", empty: "Spezifische Vorschl\u00E4ge konnten derzeit nicht geladen werden.", faq: "H\u00E4ufige Fragen", continue: "Weiter entdecken", read: "Ratgeber lesen" },
it: { back: "Torna alle guide", by: "Contenuti di", summary: "In sintesi", catalogue: "Esplora il catalogo", products: "Prodotti correlati a questa guida", productText: "Questi suggerimenti provengono dal catalogo attivo. Verifica disponibilit\u00E0, prezzo, quantit\u00E0 e personalizzazione nella pagina di ogni prodotto.", solutions: "Esplora per budget e quantit\u00E0", search: "Cerca nel catalogo", empty: "Al momento non \u00E8 stato possibile caricare suggerimenti specifici.", faq: "Domande frequenti", continue: "Continua a esplorare", read: "Leggi la guida" },
} as const;
